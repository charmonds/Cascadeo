<?php
	$img_addr = array("menu_dashboard","menu_myclasses","menu_resources","menu_account");
	$div_on = "<div class=\"menu-selected\">";	
	$div_end = "</div>";
	$div_off = "<div class=\"menu-item\">";
	
	$menu_div = array($div_off, $div_off, $div_off, $div_off);
...
<table cellspacing=0 cellpadding=0>
	<tr>
		...
		<td>
			<a href="my_resources.php?uid=<?php echo $uid; ?>&action=view">
				<?php echo $menu_div[2]; ?>

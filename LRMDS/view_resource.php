			...
			<div id="page-content">			
				...
				<div class="function-group2">
					...
					<?php
						...
						$myResultSet = mysql_query("SELECT getID('l', $uid, $rid) as lr_id", $myConnection);
						$record = mysql_fetch_array($myResultSet);
						
						if( $record['lr_id'] == NULL){

							echo "<div class=\"right\">";
							echo "<a class=\"submit-function1\" href=\"add_to_shelf.php?rid=";
							echo $rid;
							echo "&uid=";
							echo $uid;
							echo "&cid=";
						...
						else echo "<br><br>Already on shelf";
					?>
